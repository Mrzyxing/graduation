<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_local_ip.aspx.cs" Inherits="user_view_local_ip" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">查看本机IP地址</td>
				</tr>
			</table>
			<TABLE cellSpacing="1" cellPadding="3" width="96%" align="center" bgColor="#77aeee" border="0">
                <tr>
                    <td bgcolor="#ffffff" style="height:22px;"><asp:Label ID="txtClientIP" runat="server"></asp:Label></td>
                </tr>
                </TABLE>
    </form>
</body>
