<%@ Page Language="C#" AutoEventWireup="true" CodeFile="modify_profile_prs.aspx.cs" Inherits="user_modify_profile_prs" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="96%" align="center" bgColor="#77aeee" border="0">
                <tr>
                    <td bgcolor="#ffffff" style="height:22px;">修改我的资料成功。</td>
                </tr>
                </TABLE>
    </form>
</body>
