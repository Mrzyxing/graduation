<%@ Page Language="C#" AutoEventWireup="true" CodeFile="download_history.aspx.cs" Inherits="admin_download_history" %>
...
<body>
    <form id="form1" runat="server">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">下载历史记录</td>
				</tr>
			</table>
						<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td>
					<asp:GridView ID="GridView1" runat="server" Width="100%"  DataKeyNames ="DownloadHistoryID" CellPadding ="4" AutoGenerateColumns="False" BackColor="#77aeee" BorderColor="#77aeee" BorderStyle="Solid">
                            <Columns>
                              <asp:BoundField DataField="DownloadHistoryID" HeaderText="ID编号" ></asp:BoundField>
                               <asp:TemplateField HeaderText="下载的文件">
                                <ItemTemplate>
										<a href='../upfile/affix/<%#Eval("UpFileName")%>'><%#Eval("UpFileName")%></a>
								</ItemTemplate>
								</asp:TemplateField>
								<asp:BoundField DataField="FileContent" HeaderText="文件说明" ></asp:BoundField>            
                               <asp:BoundField DataField="DownDatetime" DataFormatString="{0:yyyy-M-dd}" HeaderText="下载时间" ></asp:BoundField>
                               <asp:BoundField DataField="Contactor" HeaderText="下载人" ></asp:BoundField>
                            </Columns>
